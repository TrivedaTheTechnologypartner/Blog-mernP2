        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-l lg:pl-8">
                    <p className="text-dark-grey md-2 mt-9">Blog Title</p>
                    <input 
                    type="text"
                    ...
                    <p className="text-dark-grey md-2 mt-9">Short description about your blog</p>
                    ...
                    <p className="mt-l text-dark-grey text-sm text-right">{characterLimit - des.length} characters left</p>

                    <p className="text-dark-grey md-2 mt-9">Topics - ( Helps in searching and ranking your blog post )</p>
